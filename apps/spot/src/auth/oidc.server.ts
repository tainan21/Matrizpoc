...
export function oidcConfig(): OidcBffConfig { return { issuer: required("MATRIZ_IDENTITY_ISSUER"), clientId: required("SPOT_OIDC_CLIENT_ID"), clientSecret: required("SPOT_OIDC_CLIENT_SECRET"), appId: "spot", callbackUrl: required("SPOT_OIDC_CALLBACK_URL"), sessionSecret: required("SPOT_SESSION_SECRET") } }
