...
export function oidcConfig(): OidcBffConfig { return { issuer: required("MATRIZ_IDENTITY_ISSUER"), clientId: required("WILLDASH_OIDC_CLIENT_ID"), clientSecret: required("WILLDASH_OIDC_CLIENT_SECRET"), appId: "willdash", callbackUrl: required("WILLDASH_OIDC_CALLBACK_URL"), sessionSecret: required("WILLDASH_SESSION_SECRET") } }
