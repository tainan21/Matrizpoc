...
export const manifest: AppManifestDTO = {
  ...
  routes: [
    ...
    { label: "Portas", path: "/ports", order: 6 },
    { label: "Git", path: "/git", order: 7 },
    { label: "Terminal", path: "/terminal", order: 8 },
    { label: "Navegador", path: "/browser", order: 9 },
    { label: "Ações", path: "/actions", order: 10 },
    { label: "Store", path: "/store", order: 11 },
    { label: "Doctor", path: "/doctor", order: 12 },
    { label: "Ajustes", path: "/settings", order: 13 },
  ],
  capabilities: [
