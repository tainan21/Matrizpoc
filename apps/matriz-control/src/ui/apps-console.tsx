...
import { WorkbenchRuntimeCard } from "./workbench-runtime-card"

export function AppsConsole() {
  const [projects, setProjects] = useState<TerminalProject[]>([])
  const [selectedId, setSelectedId] = useState<string | null>("__workbench")
