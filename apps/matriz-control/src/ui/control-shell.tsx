...
function Shell({ children }: { children: ReactNode }) {
  ...
  return <div className={`control-root ${styles.root} dock-${terminal.open ? terminal.placement : "closed"}`} data-theme={theme} data-active-app={activeApp?.appId === "health" ? "health" : undefined}>
...
export function ControlShell({ children }: { children: ReactNode }) { return <ThemeProvider><InstalledAppsProvider><ProjectHostProvider><TerminalProvider><Shell>{children}</Shell></TerminalProvider></ProjectHostProvider></InstalledAppsProvider></ThemeProvider> }
