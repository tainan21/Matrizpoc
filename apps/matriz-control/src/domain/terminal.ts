...
export interface ResolvedTerminalAction { projectId: string; projectName: string; actionId: string; label: string; command: string; args: string[]; cwd: string; route?: string; port?: number | null; environment?: Readonly<Record<string, string>>; redactions?: readonly string[] }
