...
export const manifest: AppManifestDTO = {
  ...
  routes: [
    ...
    { label: "Engineering", path: "/engineering", order: 10 },
    { label: "Projects", path: "/projects", order: 11 },
    { label: "Health", path: "/health", order: 12 },
    { label: "Health checks", path: "/health/checks", order: 13 },
    { label: "Ecosystem", path: "/ecosystem", order: 14 },
    { label: "Intelligence", path: "/intelligence", order: 15 },
    { label: "Public", path: "/public", order: 16 },
