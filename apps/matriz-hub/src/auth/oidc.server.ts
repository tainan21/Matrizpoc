...
export function oidcConfig(): OidcBffConfig { return { issuer: required("MATRIZ_IDENTITY_ISSUER"), clientId: required("HUB_OIDC_CLIENT_ID"), clientSecret: required("HUB_OIDC_CLIENT_SECRET"), appId: "matriz-hub", callbackUrl: required("HUB_OIDC_CALLBACK_URL"), sessionSecret: required("HUB_SESSION_SECRET") } }
