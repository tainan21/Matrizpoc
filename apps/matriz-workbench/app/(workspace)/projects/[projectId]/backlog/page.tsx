...
import { WorkItemBoard } from "../../../../../src/ui/components/work-item-board"
...
import {
  toWorkItemBoardViewModel,
  toWorkItemInspectorViewModel,
} from "../../../../../src/ui/presenters/work-item-board-presenter"
...
export default async function BacklogPage({
  ...
  const selectedItem = filters.item
    ? items.find((item) => item.id === filters.item)
    : undefined
  ...
  return (
    <WorkItemBoard
      initialBoard={toWorkItemBoardViewModel(items, requests)}
      projectId={projectId}
