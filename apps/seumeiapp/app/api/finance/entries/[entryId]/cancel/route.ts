...
import { cancelFinanceEntryHandler } from "../../../../../../src/http/finance-handlers"
...
export async function POST(request: NextRequest, context: { params: Promise<{ entryId: string }> }) {
  ...
  return executeCompanyRequest(request, (services, actor) => cancelFinanceEntryHandler(actor, companyId, entryId, body, services))
}
