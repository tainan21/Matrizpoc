...
export function oidcConfig(): OidcBffConfig {
  return {
    issuer: required("MATRIZ_IDENTITY_ISSUER"),
    clientId: required("SEUMEI_OIDC_CLIENT_ID"),
    clientSecret: required("SEUMEI_OIDC_CLIENT_SECRET"),
    appId: "seumei",
    callbackUrl: required("SEUMEI_OIDC_CALLBACK_URL"),
    sessionSecret: required("SEUMEI_SESSION_SECRET"),
  }
}
