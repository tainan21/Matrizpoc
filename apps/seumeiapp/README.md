...
Aplicação web multitenant da Seumei no ecossistema Matriz. O fluxo funcional cria ou seleciona uma empresa autorizada, persiste tenant e membership OWNER, retoma o onboarding, abre o workspace real e administra a equipe com capacidades por papel.
...
- `/api/companies`, `/api/company-selection`, `/api/onboarding`, `/api/members` e `/api/invitations/accept`: fronteiras HTTP app-local.
