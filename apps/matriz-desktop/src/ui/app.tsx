  ...
  return (
    <div className={`control-shell${view !== "terminal" ? " has-terminal-dock" : ""}`} data-matrizlib="0.1.0" data-theme={desktop.settings?.theme ?? initialTheme}>
      ...
      <main className="control-main">
        ...
        {view === "doctor" ? <DoctorView checks={checks} refresh={() => gateway.doctor().then(setChecks)} previewRemedy={gateway.previewDoctorRemedy} confirmRemedy={gateway.confirmDoctorRemedy} open={chooseView} /> : null}
