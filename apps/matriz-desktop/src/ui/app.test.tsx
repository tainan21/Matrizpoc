...
function gateway(): DesktopGateway {
  return {
    ...
    gitSnapshot: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [] }),
    gitDiff: vi.fn().mockResolvedValue({ changeId: "change", staged: false, lines: [], truncated: false }),
    gitStage: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [] }),
    gitUnstage: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [] }),
    gitCommit: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [] }),
