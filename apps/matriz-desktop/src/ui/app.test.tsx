...
function gateway(): DesktopGateway {
  return {
    ...
    previewGitMerge: vi.fn().mockResolvedValue({ target: "feature", commits: 1, changedFiles: 1, confirmationToken: "merge-token", expiresAt: Date.now() + 30_000 }),
    confirmGitMerge: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [], branches: [], reflog: [] }),
    abortGitMerge: vi.fn().mockResolvedValue({ revision: "rev", branch: "main", ahead: 0, behind: 0, changes: [], recent: [], branches: [], reflog: [] }),
