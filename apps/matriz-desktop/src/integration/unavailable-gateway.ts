...
export const unavailableGateway: DesktopGateway = {
  ...
  doctor: async () => [],
  previewDoctorRemedy: async () => unavailable(),
  confirmDoctorRemedy: async () => unavailable(),
  ...
  previewGitMerge: async () => unavailable(),
  confirmGitMerge: async () => unavailable(),
  abortGitMerge: async () => unavailable(),
  ...
  infrastructureSnapshot: async () => ({ revision: "preview", root: "%LOCALAPPDATA%\\Matriz\\Infrastructure", services: [] }),
  previewInfrastructureAction: async () => unavailable(),
  confirmInfrastructureAction: async () => unavailable(),
  infrastructureLogs: async () => [],
  ...
  infrastructureEventDiagnostics: async () => [],
