...
describe("Matriz Ops + Pay foundation", () => {
  it("registers independent runtimes without changing Matriz Admin", () => {
    ...
    expect(monorepoConfig.baseUrls["matriz-control"]).toBe("http://127.0.0.1:3009")
    expect(monorepoConfig.baseUrls["matriz-ops"]).toBe("http://127.0.0.1:3011")
    expect(monorepoConfig.baseUrls["matriz-pay"]).toBe("http://127.0.0.1:3012")
  })
