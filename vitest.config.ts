...
>>>>>>> 73482d5 (checkpoint: preserve Wave 1 OIDC foundation worktree)
  ...
  resolve: {
    alias: {
      ...
      "@matriz/design-ui/sounds": resolve(__dirname, "./packages/design/ui/src/sounds/index.ts"),
      ...
      "@matriz/integration-api-contracts/v1/docs": resolve(__dirname, "./packages/integration/api-contracts/src/v1/docs/index.ts"),
      ...
      "@matriz/integration-wallet-contracts": resolve(__dirname, "./packages/integration/wallet-contracts/src/index.ts"),
      ...
      "@matriz/platform-telemetry": resolve(__dirname, "./packages/platform/telemetry/src/index.ts"),
      ...
      "@apps/matriz-ops/public-contract": resolve(__dirname, "./apps/matriz-ops/public-contract.ts"),
      "@apps/matriz-pay/public-contract": resolve(__dirname, "./apps/matriz-pay/public-contract.ts"),
