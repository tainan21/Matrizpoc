 ...
 *
 * Pure visual contracts for Matriz products. Product domains and commercial
 * policy belong outside this package (L4/L12).
 */
<<<<<<< HEAD
export * from "./tokens"
export * from "./themes"
...
export const appThemes: Readonly<Record<MatrizAppId, AppThemeTokens>> = {
  "matriz-identity": {
    appId: "matriz-identity", label: "Matriz Identity", brandAccent: "#4338ca", brandAccentFg: "#ffffff",
    surface: "#ffffff", surfaceFg: "#111827", muted: "#eef2ff", mutedFg: "#3730a3", border: "#c7d2fe",
  },
  "matriz-hub": {
    appId: "matriz-hub",
    label: "Matriz Hub",
...
export const darkAppThemes: Readonly<Record<MatrizAppId, AppThemeTokens>> = {
  "matriz-identity": {
    appId: "matriz-identity", label: "Matriz Identity", brandAccent: "#a5b4fc", brandAccentFg: "#111827",
    surface: "#0b1020", surfaceFg: "#f5f7ff", muted: "#151b35", mutedFg: "#bac2e8", border: "#303a69",
  },
  "matriz-hub": {
